...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (savedBlogs) {
      ...
      const languageBlogs = MOCK_BLOGS_BY_LANG[lang] || MOCK_BLOGS_BY_LANG['en'];
      setBlogs(languageBlogs);
    }
  ...
  useEffect(() => {
    if (isLoaded) {
      const storageKeyBlogs = `ld_blogs_${lang}`;
      localStorage.setItem(storageKeyBlogs, JSON.stringify(blogs));
    }
  }, [blogs, lang, isLoaded]);
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
            <div className="order-2 lg:order-1 lg:w-80 shrink-0">
               ...
               <button 
                 ...
                 className="mt-8 lg:mt-10 w-full flex items-center justify-center gap-3 p-6 glass rounded-[2rem] md:rounded-[2.5rem] text-slate-500 font-black uppercase tracking-widest text-[10px] hover:text-slate-950 dark:hover:text-white transition-all group shadow-xl hover:shadow-2xl"
               >
